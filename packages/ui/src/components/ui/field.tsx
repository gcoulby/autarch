...
function FieldContent({ className, ...props }: React.ComponentProps<'div'>) {
  return <div data-slot="field-content" className={cn('group/field-content flex flex-col flex-1 gap-1.5 leading-snug', className)} {...props} />
}
...
function FieldTitle({ className, ...props }: React.ComponentProps<'div'>) {
  return (
    <div
      data-slot="field-label"
      className={cn('flex items-center gap-2 group-data-[disabled=true]/field:opacity-50 w-fit font-medium text-sm leading-snug', className)}
      {...props}
    />
  )
}
