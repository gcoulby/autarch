...
function Command({ className, ...props }: React.ComponentProps<typeof CommandPrimitive>) {
  return (
    <CommandPrimitive
      data-slot="command"
      className={cn('flex flex-col bg-popover rounded-md w-full h-full overflow-hidden text-popover-foreground', className)}
      {...props}
    />
  )
}
...
function CommandSeparator({ className, ...props }: React.ComponentProps<typeof CommandPrimitive.Separator>) {
  return <CommandPrimitive.Separator data-slot="command-separator" className={cn('-mx-1 bg-border h-px', className)} {...props} />
}
