...
function DialogHeader({ className, ...props }: React.ComponentProps<'div'>) {
  return <div data-slot="dialog-header" className={cn('flex flex-col gap-2 sm:text-left text-center', className)} {...props} />
}
...
function DialogFooter({
  ...
  return (
    <div data-slot="dialog-footer" className={cn('flex sm:flex-row flex-col-reverse sm:justify-end gap-2', className)} {...props}>
      {children}
      {showCloseButton && (
