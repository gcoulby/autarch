  ...
  return (
    <DayPicker
      ...
      classNames={{
        ...
        weekday: cn('flex-1 rounded-md font-normal text-[0.8rem] text-muted-foreground select-none', defaultClassNames.weekday),
        ...
        today: cn('bg-accent rounded-md data-[selected=true]:rounded-none text-accent-foreground', defaultClassNames.today),
